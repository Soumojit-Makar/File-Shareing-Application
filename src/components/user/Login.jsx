...
import { User, Mail, Lock, Phone, MapPin, MessageSquare, Users, Eye, EyeOff, UserPlus, RotateCcw, UserLock, LucideUserLock } from "lucide-react";
    ...
    return (
      <div className="relative group">
        <div className={`relative transition-all duration-300 ${isFocused ? 'transform scale-[1.02]' : ''
          ...
          <div className={`relative bg-white/5 backdrop-blur-sm border rounded-xl transition-all duration-300 ${isFocused
              ? 'border-purple-400 shadow-lg shadow-purple-500/25'
              : 'border-white/20 hover:border-white/30'
            }`}>
            <div className="flex items-center p-4">
              <Icon className={`w-5 h-5 mr-3 transition-colors duration-300 ${isFocused ? 'text-purple-400' : 'text-gray-400'
                }`} />
        ...
        <div className={`absolute -top-2 left-4 px-2 bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 text-sm font-medium transition-all duration-300 ${isFocused || hasValue
        ...
        <div className="bg-white/10 backdrop-blur-lg border border-white/20 rounded-3xl p-8 shadow-2xl">
          ...
          <div className="text-center mb-8">
            <div className="inline-flex items-center justify-center w-16 h-16 bg-gradient-to-r from-purple-500 to-pink-500 rounded-2xl mb-4">
              <LucideUserLock className="w-8 h-8 text-white" />
            </div>
            <h1 className="text-4xl font-bold bg-gradient-to-r from-white to-purple-300 bg-clip-text text-transparent mb-2">
              Login to FileVault
            </h1>
            <p className="text-gray-400">Welcome Back to FileVault and start sharing securely</p>
          </div>
            ...
            <div className="flex flex-col sm:flex-row gap-4 pt-6">
              ...
              >
                {loading ? (
                  ...
                  <>
                    <UserLock className="w-5 h-5 mr-2 group-hover:scale-110 transition-transform" />
                    Login
                  </>
                )}
              </button>
